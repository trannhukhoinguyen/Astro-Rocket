...
description: "Astro Rocket renders an optional table of contents on blog posts in three layouts: inline card, sticky sidebar, or both. Scroll-spy highlights the reader's position. Pick the layout that fits your audience."
