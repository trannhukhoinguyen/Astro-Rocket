---
title: "Astro Rocket"
description: "Astro Rocket — my free, open-source Astro 6 theme. A finished website you launch by changing the text: 12 colour themes, 57 components, a 3-state colour mode, and a 100/100/100/100 Lighthouse score out of the box."
...
meta: ["Free & open source", "MIT licence", "Astro 6", "Lighthouse 4×100"]
icon: "rocket"
image: "../../../assets/projects/hans-martens-dev-astro-rocket.jpg"
imageAlt: "Astro Rocket — my open-source Astro 6 theme, shown on its astrorocket.dev demo."
---
...
**Astro Rocket** is my own free, open-source theme, built on **Astro 6** and **Tailwind CSS v4**. It isn't a boilerplate you spend a week wiring up — it's a finished website. Every page is already designed and built, so you change the text, pick a colour, and go live.
